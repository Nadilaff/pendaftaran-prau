...
<body>
        ...
        <div class="container box-jalur">
            <div class="row align-items-center">
                <div class="jalur-text col-lg-6 col-xl-6 col-12">
                    <h1>Gunung Prau Via Igirmranak</h1>
                    <p>
                        Jalur ini terletak di Igirmranak, Kec. Kejajar, Kabupaten Wonosobo, Jawa Tengah. Jalur pendakian Gunung Prau via
                        ...
                        Curug Gamelan, Pos Bukit Cendani, dan Pos Roto Dowo.
                    </p>
                </div>
                <div class="col-lg-6 col-xl-6 col-12">
                    <img src="<?= base_url('assets/user/'); ?>images/Igirmranak.png" alt="" class="bc-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <img src="<?= base_url('assets/user/'); ?>images/jalur igirmranak.png" alt="" class="jalur-img">
        </div>
    </div>
    <!--END PETA JALUR-->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="<?= base_url('assets/user/'); ?>images/jalur igirmranak.png" class="modal-img" alt="modal-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            <h1 class="tittle-rating text-center">Ulasan Jalur Igirmranak</h1>
            <div class="row">
