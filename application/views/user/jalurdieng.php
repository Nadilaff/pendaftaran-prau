...
<body>
            ...
            <div class="row align-items-center">
                <div class="jalur-text col-lg-6 col-xl-6 col-12">
                    ...
                    <p>Jalur ini terletak di Jl. Raya Wonosobo, Batur - Dieng Jl. Dieng Km. 26, Kec. Kejajar, Kabupaten Wonosobo, Jawa Tengah.
                        ...
                        dan pos empat puncak gunung Prau.
                    </p>
                </div>
                <div class="col-lg-6 col-xl-6 col-12">
                    <img src="<?= base_url('assets/user/'); ?>images/Dieng.png" alt="" class="bc-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <img src="<?= base_url('assets/user/'); ?>images/jalur dieng.png" alt="" class="jalur-img">
        </div>
    </div>
    <!--END PETA JALUR-->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="<?= base_url('assets/user/'); ?>images/jalur dieng.png" class="modal-img" alt="modal-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid container-galeri">
        <div class="container">
            <div class="row header-galeri text-center">
                ...
                <div class="col-6 offset-3">
                    <p>
                        Jelajahi galeri dari petualangan seru di Gunung Merbabu. Dalam setiap gambar, temukan cerita kegigihan dan keindahan
    ...
    <div class="container-fluid">
        <div class="container">
            <h1 class="tittle-rating text-center">Ulasan Jalur Dieng</h1>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 container-review">
                    <div class="review-body">
                        ...
                        <div class="profil-container mb-1">
                            <img src="<?= base_url('assets/user/'); ?>images/kucing.jpg" alt="Foto Profil" class="profile-picture">
                            <span class="username">Nadila</span>
                        </div>
                        <p class="review-text">Selection image line ellipse arrange. Select vertical selection project union layer. Variant layout prototype device
                            bold selection content library. Link flows overflow project move pen hand frame underline export. Ipsum device boolean
                            undo plugin reesizing clip italic bold reesizing. Selection image line ellipse arrange. Select vertical selection project union layer. Variant layout prototype device
                            bold selection content library. Link flows overflow project move pen hand frame underline export. Ipsum device boolean
                    ...
                    <div class="review-body">
                        ...
                        <p class="review-text">Selection image line ellipse arrange. Select vertical selection project union layer. Variant
                            layout prototype device
                            bold selection content library. Link flows overflow project move pen hand frame underline export. Ipsum device
                            boolean
                            undo plugin reesizing clip italic bold reesizing. Selection image line ellipse arrange. Select vertical
