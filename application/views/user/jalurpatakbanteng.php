...
<body>
        ...
        <div class="container box-jalur">
            <div class="row align-items-center">
                <div class="jalur-text col-lg-6 col-xl-6 col-12">
                    <h1>Gunung Prau Via Patak Banteng</h1>
                    <p>
                        Jalur ini terletak di Jl. Dieng KM. 24, Patakbanteng, Kec. Kejajar, Kabupaten Wonosobo, Jawa Tengah. Jalur pendakian
                        Gunung Prau via Patak Banteng merupakan jalur paling favorit yang biasa dipilih pendaki. Hal ini karena rutenya
                        terbilang lebih singkat dibandingkan jalur lainnya. Selain itu, beragam fasilitas juga telah memenuhi untuk kenyamanan
                        pendakian, rutenya tidak terlalu sulit dan rutenya paling dekat dengan puncak Prau. Untuk menempuh jalur Patak Banteng
                        pendaki hanya perlu menempuh jarak sekitar 4 kilometer atau jika ditarik garis lurus hanya 600 meter. Terdapat empat pos
                        yang melalui Patak Banteng yaitu Pos 1 Sikut Dewo, Pos 2 Canggal Walangan, Pos 3 Cacingan, dan Pos 4 Plawangan. Kemudian
                        pendaki bisa mendirikan tenda di Sunrise Camp.
                    </p>
                </div>
                <div class="col-lg-6 col-xl-6 col-12">
                    <img src="<?= base_url('assets/user/'); ?>images/patak banteng.png" alt="" class="bc-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <img src="<?= base_url('assets/user/'); ?>images/jalur patakbanteng.png" alt="" class="jalur-img">
        </div>
    </div>
    <!--END PETA JALUR-->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="<?= base_url('assets/user/'); ?>images/jalur patakbanteng.png" class="modal-img" alt="modal-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            <h1 class="tittle-rating text-center">Ulasan Jalur Patak Banteng</h1>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 container-review">
                    ...
                    <div class="review-body">
                        ...
                        <div class="profil-container mb-1">
                            <img src="./assets/images/kucing.jpg" alt="" alt="Foto Profil" class="profile-picture">
                            <span class="username">Nadila</span>
                        </div>
                        <p class="review-text">Selection image line ellipse arrange. Select vertical selection project
                            union layer. Variant
