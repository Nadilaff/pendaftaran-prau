...
<body>
        ...
        <div class="container box-jalur">
            <div class="row align-items-center">
                <div class="jalur-text col-lg-6 col-xl-6 col-12">
                    <h1>Gunung Prau Via Wates</h1>
                    <p>
                        Jalur ini terletak di Jl. Candiroto - Kejajar, KM. 11, Gejungan, Wates, Kec. Wonoboyo, Kabupaten Temanggung, Jawa
                        ...
                        seperti Pos Blumbang Kodok, Cemaran, hingga sampai camp area.
                    </p>
                </div>
                <div class="col-lg-6 col-xl-6 col-12">
                    <img src="<?= base_url('assets/user/'); ?>images/wates.png" alt="" class="bc-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <img src="<?= base_url('assets/user/'); ?>images/jalur wates.png" alt="" class="jalur-img">
        </div>
    </div>
    <!--END PETA JALUR-->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="<?= base_url('assets/user/'); ?>images/jalur wates.png" class="modal-img" alt="modal-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            <h1 class="tittle-rating text-center">Ulasan Jalur Wates</h1>
            <div class="row">
