...
<body>
        ...
        <div class="container box-jalur">
            <div class="row align-items-center">
                <div class="jalur-text col-lg-6 col-xl-6 col-12">
                    <h1>Gunung Prau Via Dwarawati</h1>
                    <p>
                        Jalur ini terletak di Jl. Raya Wonosobo, Batur - Dieng Jl. Dieng Km. 26, Kec. Kejajar, Kabupaten Wonosobo, Jawa Tengah.
                        ...
                        sampai puncak dan mendirikan tenda di area camp Telaga Wurung dengan pemandangan awan menggumpal dan rumput hijau.
                    </p>
                </div>
                <div class="col-lg-6 col-xl-6 col-12">
                    <img src="<?= base_url('assets/user/'); ?>images/dwarawati.png" alt="" class="bc-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container">
            <h1 class="tittle-rating text-center">Ulasan Jalur Dwarawati</h1>
            <div class="row">
