                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form theme-form">
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select">
                                                        <option>Memperbarui gambar galeri</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label>Jalur</label>
                                                    <select class="form-select">
                                                        <option>Patak Banteng</option>
                                                        <option>Wates</option>
                                                        <option>Kalilembu</option>
                                                        <option>Dieng</option>
                                                        <option>Igirmranak</option>
                                                        <option>Dwarawati</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <form class="dropzone" id="singleFileUpload" action="https://admin.pixelstrap.com/upload.php">
                                                        <div class="dz-message needsclick"><i <i class="fa-solid fa-cloud-arrow-up"></i></i>
                                                            <h6 class=" mt-2">Letakkan file di sini atau klik untuk
                                                                mengunggah.</h6>
                                                        </div>
                                                    </form>
                                                </div>
                                        ...
                                        <div class="row"></div>
                                        <div class="col">
                                            <div class="text-end mt-3"><a class="btn me-3" style="background-color: #076461; color: white;" href="galeri.html">Simpan</a><a class="btn btn-danger" href="galeri.html" style="background-color: red;">Batal</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
