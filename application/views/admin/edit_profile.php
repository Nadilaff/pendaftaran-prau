                ...
                <div class="container-fluid">
                    <div class="edit-profile">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <?= form_open_multipart('admin/profile'); ?> <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label">Foto Profile</label>
                                                    <div class="img-container">
                                                        <img class="img-thumbnail" src="<?= base_url('assets/user/images/profile/') . $user['foto']; ?>" style="width: 180px;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="mb-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="file" id="foto" name="foto" style="background-color:white; border: none; color: black; border-bottom: 2px solid #333; margin-bottom: 10px; padding: 3px; font-size: 14px; width: 100%; box-sizing: border-box; border-radius: 0;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="nama" name="nama" value="<?= $user['nama']; ?>" style="background-color:white; border: none; color: black; border-bottom: 2px solid #333; margin-bottom: 10px; padding: 3px; font-size: 14px; width: 100%; box-sizing: border-box; border-radius: 0;">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="telepon" name="telepon" value="<?= $user['no_telepon']; ?>" style="border: none; color: black; border-bottom: 2px solid #333; margin-bottom: 10px; padding: 3px; font-size: 14px; width: 100%; box-sizing: border-box; border-radius: 0; background-color: white">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="email">Email</label>
                                                    <input class="form-control" type="text" id="email" name="email" value="<?= $user['email']; ?>" readonly style="border: none; color: black; border-bottom: 2px solid #333; margin-bottom: 10px; padding: 3px; font-size: 14px; width: 100%; box-sizing: border-box; border-radius: 0; background-color: white">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="telepon">Alamat</label>
                                                    <input class="form-control" type="text" id="alamat" name="alamat" value="<?= $user['alamat']; ?>" style="background-color:white; border: none; color: black; border-bottom: 2px solid #333; margin-bottom: 10px; padding: 3px; font-size: 14px; width: 100%; box-sizing: border-box; border-radius: 0;">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="password">Password</label>
                                                    <input class="form-control" type="password" id="password" name="password" value="<?= $user['password']; ?>" style="background-color:white; border: none; color: black; border-bottom: 2px solid #333; margin-bottom: 10px; padding: 3px; font-size: 14px; width: 100%; box-sizing: border-box; border-radius: 0;">
                                                </div>
                                            </div>
