...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/admin/'); ?>css/vendors/calendar.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-header">
            <div class="header-wrapper row m-0">
                <form class="form-inline search-full col" action="calendar-basic.html#" method="get">
                ...
                <div class="nav-right col-8 pull-right right-header p-0">
                    <ul class="nav-menus">
                        ...
                        <li class="maximize"><a class="text-dark" href="<?= base_url('kalender'); ?>" onclick="javascript:toggleFullScreen()"><i data-feather="maximize"></i></a></li>
            ...
            <div class="sidebar-wrapper">
                <div>
                    <div class="logo-wrapper">
                        ...
                        <div class="toggle-sidebar"><i class="fa fa-cog status_toggle middle sidebar-toggle" style="color: white;"> </i>
                        </div>
                    </div>
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="menu-box">
                                    <ul>
                                        ...
                                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav active" href="<?= base_url('kalender'); ?>"><i data-feather="calendar"> </i><span>Kalender</span></a></li>
                                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="dataPemesanan.html"><i class="fa fa-envelope" style="transform: translateY(-7%); padding-right: 10px;">
    ...
    <script src="<?= base_url('assets/admin/'); ?>js/calendar/fullcalendar-custom.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
