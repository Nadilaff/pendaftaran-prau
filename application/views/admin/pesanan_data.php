...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/admin/'); ?>css/vendors/datatable-extension.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-header">
            <div class="header-wrapper row m-0">
                <form class="form-inline search-full col" action="datatable-ext-autofill.html#" method="get">
                ...
                <div class="nav-right col-8 pull-right right-header p-0">
                    <ul class="nav-menus">
                        ...
                        <li class="maximize"><a class="text-dark" href="datatable-ext-autofill.html#!" onclick="javascript:toggleFullScreen()"><i data-feather="maximize"></i></a></li>
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="menu-box">
                                    <ul>
                                        ...
                                        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i data-feather="mail"></i><span>Pesanan</span></a>
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title" href="javascript:void(0)"><i data-feather="check-square"></i><span>Jalur</span></a>
                                            <ul class="sidebar-submenu">
                                                <li><a href="informasiJalur.html">Informasi Jalur</a></li>
                                                <li><a href="galeri.html">Galeri</a></li>
                                                <li><a href="editJalur.html">Edit Jalur</a></li>
                                                <li><a href="editGaleri.html">Edit Galeri</a></li>
                                                <li><a href="historyAktivitas.html">History Aktivitas</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i data-feather="users"></i><span>Aakun</span></a>
                                            <ul class="sidebar-submenu">
                                        ...
                                        <table class="display" id="export-button">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="action">
                                                            <li class="edit"><a href="dataPemesananKelompok.html"><i class="fa fa-folder-open" style="color: #076461; padding-right: 1rem;"></i></li>
                                                            <li class="delete"><a href="editDataPemesanan.html"><i class="fa fa-pencil"></i></a></li>
                                                        </ul>
                                                    </td>
                                                </tr>
                                                <tr>
    ...
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.buttons.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/jszip.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/buttons.colVis.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/pdfmake.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/vfs_fonts.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.autoFill.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.select.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/buttons.bootstrap4.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/buttons.html5.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/buttons.print.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.bootstrap4.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.responsive.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/responsive.bootstrap4.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.keyTable.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.colReorder.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.fixedHeader.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.rowReorder.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/dataTables.scroller.min.js"></script>
    <script src="<?= base_url('assets/admin/'); ?>js/datatable/datatable-extension/custom.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
